...
public class SimpleJasoDecomposer {
	/* **********************************************
	 * 자음 모음 분리
	 * 설연수 -> ㅅㅓㄹㅇㅕㄴㅅㅜ,    바보 -> ㅂㅏㅂㅗ
	 * **********************************************/
    /** 초성 - 가(ㄱ), 날(ㄴ) 닭(ㄷ) */
    static char[] arrChoSung = { 0x3131, 0x3132, 0x3134, 0x3137, 0x3138,
            0x3139, 0x3141, 0x3142, 0x3143, 0x3145, 0x3146, 0x3147, 0x3148,
            0x3149, 0x314a, 0x314b, 0x314c, 0x314d, 0x314e };
    /** 중성 - 가(ㅏ), 야(ㅑ), 뺨(ㅑ)*/
    static char[] arrJungSung = { 0x314f, 0x3150, 0x3151, 0x3152,
            0x3153, 0x3154, 0x3155, 0x3156, 0x3157, 0x3158, 0x3159, 0x315a,
            0x315b, 0x315c, 0x315d, 0x315e, 0x315f, 0x3160, 0x3161, 0x3162,
            0x3163 };
    /** 종성 - 가(없음), 갈(ㄹ) 천(ㄴ) */
    static char[] arrJongSung = { 0x0000, 0x3131, 0x3132, 0x3133,
	 ...
	 * **********************************************/
    /** 초성 - 가(ㄱ), 날(ㄴ) 닭(ㄷ) */
    static String[] arrChoSungEng = { "r", "R", "s", "e", "E",
            "f", "a", "q", "Q", "t", "T", "d", "w",
            "W", "c", "z", "x", "v", "g" };

    /** 중성 - 가(ㅏ), 야(ㅑ), 뺨(ㅑ)*/
    static String[] arrJungSungEng = { "k", "o", "i", "O",
            "j", "p", "u", "P", "h", "hk", "ho", "hl",
            "y", "n", "nj", "np", "nl", "b", "m", "ml",
            "l" };

    /** 종성 - 가(없음), 갈(ㄹ) 천(ㄴ) */
    static String[] arrJongSungEng = { "", "r", "R", "rt",
            "s", "sw", "sg", "e", "f", "fr", "fa", "fq",
            "ft", "fx", "fv", "fg", "a", "q", "qt", "t",
            "T", "d", "w", "c", "z", "x", "v", "g" };

    /** 단일 자음 - ㄱ,ㄴ,ㄷ,ㄹ... (ㄸ,ㅃ,ㅉ은 단일자음(초성)으로 쓰이지만 단일자음으론 안쓰임) */
    static String[] arrSingleJaumEng = { "r", "R", "rt",
            "s", "sw", "sg", "e","E" ,"f", "fr", "fa", "fq",
            "ft", "fx", "fv", "fg", "a", "q","Q", "qt", "t",
            "T", "d", "w", "W", "c", "z", "x", "v", "g" };


    public String getAlphabeticSeqs(String token, String type) {
        String word = token;
        ...
        if(type.equalsIgnoreCase("eng"))
            return resultEng ;
        else if (type.equalsIgnoreCase("han"))
            return result ;
        else //default
            return resultEng ;
    ...
    public static void main(String args[]) {
        ...
        String word 		= "박성수";
        String result		=  uni.getAlphabeticSeqs(word, "han");									// 결과 저장할 변수
        String resultEng	= uni.getAlphabeticSeqs(word, "eng");									// 알파벳으로
